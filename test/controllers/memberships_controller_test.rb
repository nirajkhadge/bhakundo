...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { league: @membership.league, user: @membership.user } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { league: @membership.league, user: @membership.user } }
