...
class WeeksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post weeks_url, params: { week: { week_ends_at: @week.week_ends_at, week_number: @week.week_number, week_starts_at: @week.week_starts_at } }
    end
  ...
  test "should update week" do
    patch week_url(@week), params: { week: { week_ends_at: @week.week_ends_at, week_number: @week.week_number, week_starts_at: @week.week_starts_at } }
